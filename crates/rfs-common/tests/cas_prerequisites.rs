...
use rfs_common::cas::{Blob, CasClient, CasConfig};
use rfs_common::digest::Digest;
use rfs_common::tree::decode_directory;
...
async fn tree_fixture_round_trips_through_local_cas() {
    ...
    let fixture = Path::new(env!("CARGO_MANIFEST_DIR")).join("../../tests/fixtures/tree-roundtrip");
